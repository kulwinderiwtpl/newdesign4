...
?>
  <?= $this->Flash->render() ?>
    <?= $this->Form->create($user,['id'=>'user_add_form', 'name'=>'user_add_form', 'class'=>'form-horizontal','autocomplete'=>'off','novalidate'=>'novalidate']) ?>
      ...
      <div class="form-actions">
        <div class="row">
          <div class="col-md-offset-3 col-md-9">
            ...
            <?=$this->Form->button(__('Add Member'),['class'=>'btn green','type'=>'submit']) ?>
        ...
        <script type="text/javascript">
          ...
          <?php if($this->request->is('Ajax')){ ?>
            ...
            $('#user_add_form').on('submit', function(e) {
                ...
                $.ajax({
                type: "POST",
                url: '<?=$this->Url->build(["controller" => "Users","action" => "add"], true);?>',
                data: data
                }).done(function(data) {
