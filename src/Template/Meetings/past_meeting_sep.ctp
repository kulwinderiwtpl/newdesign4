...
?>
  ...
  <div class="page-head">
    ...
    <div class="page-title">
      <h1>Past Meeting before sep 2017
    ...
    <div class="portlet-body">
      <div class="tab-content">
        ...
        <div class="tab-pane <?=isset($_GET['tab']) && $_GET['tab']=='meeting' || !isset($_GET['tab'])?'active':''?>" id="portlet_tab1">
          <h4 class="block"> <i class="fa fa-calendar-o"></i>  <?=h($latest->date) ?> </h4>
          ...
          <?php //pr($user); ?>
            ...
            <?= $this->Form->create(null, array('class' => 'form-horizontal', 'id' => 'rsvp_booking','novalidate'=>'novalidate')) ?>
              ...
              <div class="form-body">
                  ...
                  <div class="alert alert-warning">You have already submitted an RSVP for yourself . If you'd like to RSVP for a colleague, please use the button above "Book a colleague as an attendee".</div>
                  <?php } ?>
                          ...
                          <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-6">
                              <div class="input-icon right">
                                <i class="fa"></i>
                                <?= $this->Form->text('user_name', array('div' =>  false,'class' => 'form-control', 'label' => false,'placeholder'=>__('Enter your full name.'),'value'=>$user->first_name.' '.$user->last_name)); ?>
  ...
  <!--<nav class="large-3 medium-4 columns" id="actions-sidebar">
   ...
   <script>
  $('#meetings').focus().addClass("active");
$('#pastmeetingssep').addClass("active");
  </script>