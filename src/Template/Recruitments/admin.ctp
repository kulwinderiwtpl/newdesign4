    ...
    <div class="portlet-body" style="display: none">
      ...
      <div class="note note-info">
        ...
        <ul>
          ...
          <li> Go to the Add Recruitment tab to add a new recruitment. </li>
  ...
  <div class="portlet light bordered">
    <div class="portlet-title tabbable-line">
      <div class="caption">
        ...
        <span class="caption-subject font-dark bold uppercase">Recruitment</span>
      </div>
      <ul class="nav nav-tabs">
        <li class="active">
          <a href="#portlet_tab1" data-toggle="tab">Recruitment Listing </a>
        </li>
        <li>
          <a href="#portlet_tab2" data-toggle="tab"> Add Recruitment </a>
        </li>
      </ul>
    </div>
      ...
      <?= $this->Flash->render() ?>
        <div class="tab-content">
                  ...
                  <tbody>
                    <?php foreach ($recruitments as $key=>$item): ?>
                      <tr id="row_<?=$item->id?>" class="gradeX <?=$key%2==0?'odd':'even'?>" role="row">
                        ...
                        <td>
                          <?= !empty($item->Companies['name']) ? $item->Companies['name']:$item->othercompany ?>
                        </td>
                        <td>
                          <?php if($item->pdf): ?>
                            <a href="<?= $this->request->webroot.'uploads/recruitmentfile/'.h($item->pdf); ?>" title="Open File" target="_blank">
                              <?php $file=explode('_',$item->pdf); echo $file[1]?$file[1]:$item->pdf; ?>
                            </a>
                            <?php endif; ?>
                        </td>
                        <td>
                          <?= h(date('d-m-Y',strtotime($item->closeDate))) ?>
                        </td>
                        <td align="center">
                          <a href="javascript:void(0);" class="edit-item" data-edit-id="<?=$item->id?>" data-edit-url="recruitments/edit/" title="Edit Document"><i class="fa fa-edit"></i></a>&nbsp;
                          <a href="javascript:deleteItem('recruitments/delete/',<?= h($item->id) ?>)" data-toggle="confirmation" data-original-title="Are you sure you want to delete this document?"><i title="Delete Document" class="fa fa-times">&nbsp;</i></a>
          ...
          <div class="tab-pane" id="portlet_tab2">
            <?= $this->Form->create($recruitment,['url' => ['action' => 'add'],'name'=>'add_form','id'=>'add_form','class'=>'form-horizontal','autocomplete'=>'off','novalidate'=>'novalidate','type' => 'file']) ?>
              <div class="form-body">
                ...
                <div class="form-group  margin-top-20">
                  ...
                  <div class="col-md-4">
                    <div class="input-icon right">
                      <i class="fa"></i>
                      <?=$this->Form->select('company_id', $companies,['class'=>'form-control','id'=>'company_id','value'=>''])?>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group  ">
                  ...
                  <div class="col-md-6">
                    <div class="input-icon right">
                      <i class="fa"></i>
                      <?=$this->Form->text('othercompany',['class'=>'form-control','title'=>'Enter other/unlisted company name.','id'=>'othercompany'])?>
              ...
              <div class="form-group  ">
                ...
                <div class="col-md-4">
                  <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                    <i class="fa"></i>
                    <?=$this->Form->text('closeDate',['class'=>'form-control datepicker','title'=>'Enter closing date.','value'=>''])?>
...
<div class="input-icon right">
<i class="fa"></i>
<?=$this->Form->text('closeDate',['class'=>'form-control','title'=>'Enter closing date.'])?>
<!--<?=$this->Form->textarea('text',['class'=>'form-control','title'=>'Enter company address','rows'=>10])?>-->
              </div>
        ...
        <div class="form-actions">
          <div class="row">
            <div class="col-md-offset-3 col-md-9">
              <button type="submit" class="btn green" title="Click here to create recruitment.">Add Recruitment</button>
...
<tbody>
<?php foreach ($recruitments as $newsletter): ?>
<tr>
