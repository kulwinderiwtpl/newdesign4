...
?>
  <?= $this->Flash->render() 
        ...
        ?>
  <?= $this->Form->create($newsletter,['name'=>'edit_form','id'=>'edit_form','class'=>'form-horizontal','autocomplete'=>'off','novalidate'=>'novalidate','type' => 'file']) ?>
    <div class="form-body"> 
      ...
      <div class="form-group  margin-top-20">
        ...
        <div class="col-md-4">
          <div class="input-icon right">
            ...
            <!--<input type="text" class="form-control" name="name" title="Enter title of newsletter."> -->
            </div>
        </div>
      </div>

      <div class="form-group  ">
        <label class="control-label col-md-3" title="Enter company address.">Message
          <span class="required" aria-required="true"> * </span>
        </label>
        <div class="col-md-9">
          <div class="input-icon right">
            <i class="fa"></i>
            <?=$this->Form->textarea('text',['class'=>'editor form-control','title'=>'Enter company address','rows'=>10])?>
  ...
  <div class="table-scrollable">
    ...
    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-="" describedby="sample_1_info">
      ...
      <tbody>
        ...
        <tr>
            <td>
                <a href="<?= $this->request->webroot.'uploads/newsletters/'.h($newsletter->file); ?>" title="Open File" target="_blank">
                <?php $file=explode('_',$newsletter->file); echo isset($file[1])?$file[1]:$newsletter->file; ?>
                </a>
            </td>
            <td>
                <a href="javascript:deleteItem('newsletters/delete-file/',<?= h($newsletter->id) ?>)" title="" data-toggle="confirmation" data-original-title="Are you sure you want to delete the file?"><i class="fa fa-times">&nbsp;</i></a>
            </td>
        </tr>
        <?php } else { ?>
        <tr><td clospan="2"> No records found. </td></tr>
        <?php } ?>
      </tbody>
    </table>
    ...
    $(document).ready(function(){
        ...
        var form2 = $('#edit_form');
              ...
              $('#edit_form').on('submit', function(e) {
                ...
                $('#edit .modal-body').html('<?=$this->Html->image('components/ajax-loader.gif',array('class '=>"align-center")) ?>');
                ...
                //   contentType: false,
                  processData: false,
                  contentType: false,
                  url: '<?=$this->Url->build(["action" => "edit/".$newsletter->id], true);?>',
                  data: formData
                }).done(function(data) {
