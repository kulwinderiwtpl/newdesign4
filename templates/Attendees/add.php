...
?>
  <?= $this->Flash->render() ?>
  <?= $this->Form->create($attendee, array('class' => 'form-horizontal', 'id' => 'add_form','name'=>'add_form', 'novalidate'=>'novalidate')) ?>
...
included on the delegate list and for this to be shared with other attendees on the day.</div>
        ...
        <div class="col-md-9">
          <div class="mt-radio-list">
            <label class="mt-radio">
              <input type="radio" class="attendee-type" name="type" id="type" value="member" checked=""> Member
              <span></span>
            </label>
            <label class="mt-radio">
              <input type="radio" class="attendee-type" name="type" id="type" value="nonmember"> Non-Member
              <span></span>
            </label>
      ...
      <div class="form-group margin-top-20">
        ...
        <div class="col-md-9">
          <div class="mt-radio-list">
            <label class="mt-radio">
              <input type="radio" name="pay_method" id="pay_method1" value="cheque" title="Select payment method." checked=""> Cheque
              <span></span>
            </label>
            <label class="mt-radio">
              <input type="radio" name="pay_method" id="pay_method2" value="bacs" title="Select payment method."> BACS
              <span></span>
            </label>
      ...
      ?>
              <?=$this->Form->text('purchase_order',['class'=>'form-control','title'=>'purchase order']);?>
              <!--<input type="text" class="form-control" name="email" title="Company email address">-->
            </div>
          </div>
        </div>
      ...
      <div class="form-group attendee-type-option" id="member">
      ...
      <div class="form-group attendee-type-option" id="nonmember" style="display:none;">
    ...
    <div class="form-actions">
        <div class="row">
            <div class="col-md-offset-3 col-md-6 margin-top-20">
                <button type="submit" class="btn green" title="Click here to add attendee.">Add Attendee</button>
            </div>
        </div>
    </div>
    <?= $this->Form->end(); ?>
