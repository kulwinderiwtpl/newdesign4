                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           // pr($meetings);
                            ...
                            <tr>
                                <td><?php echo $this->Html->link(h($meeting->title),array('controller' => 'Meetings', 'action' => 'pastMeetingSep',$meeting->id)) ?> </td>
                                <td> 
                                    <?php foreach ($meeting['presentation_files'] as $presentation_file): ?>
                                    <?php if($presentation_file->file): ?><a href="<?= $this->request->webroot.'uploads/nextmeetings/'.h($presentation_file->file); ?>" title="Open Presentation" target="_blank"><i class="fa fa-file-pdf-o font-red-mint"></i> <?php $file=explode('_',$presentation_file->file); echo $file[1]?$file[1]:$presentation_file->file; ?> </a><?php endif; ?><br>
                                    <?php endforeach; ?>
                                </td>
